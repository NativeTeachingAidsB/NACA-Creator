...
import { SVGObjectExplorer } from "@/components/editor/SVGObjectExplorer";
...
export default function Home() {
  ...
  const RightPanelContent = (
    <GroupedPanelTabs
      groups={panelGroups}
      activeGroup={rightPanel.activeGroup}
      activeTab={rightPanel.activeTab}
      onGroupChange={rightPanel.setActiveGroup}
  ...
  return (
    ...
    <div className="h-screen w-screen overflow-hidden bg-background text-foreground font-sans flex">
      ...
      >
        <PaletteGroup className="h-full flex flex-col">
          <CollapsiblePalette
            id="figma"
          ...
          >
            <div className="space-y-2">
              <div className="text-xs text-muted-foreground mb-2">Import & Conversion Tools</div>
              <div className="flex gap-2">
                <Button
                  ...
                  data-testid="button-animate-import"
                >
                ...
                <Button
                  ...
                  className="h-9 px-3"
                  onClick={() => {
                    setSvgToExplore(SAMPLE_ANIMATE_SVG);
                    setShowSVGExplorer(true);
                  }}
                  data-testid="button-try-svg-explorer"
                  title="Try with a sample Animate SVG"
                >
                  Try Demo
                </Button>
              </div>
              ...
              <p className="text-xs text-muted-foreground mt-2">
                Import Adobe Animate SVG exports to create interactive objects with preserved layer structure.
              </p>
            </div>
          </CollapsiblePalette>
        </PaletteGroup>
      ...
      <Dialog open={showSVGExplorer} onOpenChange={setShowSVGExplorer}>
        <DialogContent className="w-[min(1400px,95vw)] max-w-[95vw] h-[min(900px,85vh)] max-h-[85vh] p-0 overflow-hidden">
          <VisuallyHidden>
            <DialogTitle>SVG Object Explorer</DialogTitle>
            <DialogDescription>Import Adobe Animate SVG exports as interactive objects</DialogDescription>
          </VisuallyHidden>
          <SVGObjectExplorer 
